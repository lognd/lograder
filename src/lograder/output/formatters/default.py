from .interfaces import MetadataFormatterInterface, PreprocessorOutputFormatterInterface, BuildOutputFormatterInterface, RuntimeSummaryFormatterInterface, TestCaseFormatterInterface
from .format_templates import ContextRenderer, ProcessStep
from ...builder.common.types import AssignmentMetadata, PreprocessorOutput, BuilderOutput
...
class DefaultPreprocessorContext(ContextRenderer, prefix=f"<{Fore.CYAN}BEGIN PREPROCESSOR{Fore.RESET}>\n", suffix=f"\n<{Fore.CYAN}END PREPROCESSOR{Fore.RESET}>", empty=f"<{Fore.CYAN}NO PREPROCESSOR PRESENT{Fore.CYAN}>"):
    pass

class DefaultBuilderContext(ContextRenderer, prefix=f"<{Fore.YELLOW}BEGIN BUILDER{Fore.RESET}>\n", suffix=f"\n<{Fore.YELLOW}END BUILDER{Fore.RESET}>", empty=f"<{Fore.YELLOW}NO BUILDER PRESENT{Fore.CYAN}>"):
    pass

class DefaultSTDOUTContext(ContextRenderer, prefix=f"<{Fore.BLUE}BEGIN STDOUT{Fore.RESET}>\n", suffix=f"\n<{Fore.BLUE}END STDOUT{Fore.RESET}>", empty=f"<{Fore.BLUE}EMPTY STDOUT{Fore.CYAN}>"):
    pass

class DefaultSTDERRContext(ContextRenderer, prefix=f"<{Fore.RED}BEGIN STDERR{Fore.RESET}>\n", suffix=f"\n<{Fore.RED}END STDERR{Fore.RESET}>", empty=f"<{Fore.RED}EMPTY STDERR{Fore.CYAN}>"):
    pass
